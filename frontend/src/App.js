...
function App() {
  ...
  // On app load, if we have a token, consider ourselves logged in
  useEffect(() => {
  ...
  // Side panel is open by default (when logged in)
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        {loggedIn && currentPage === 'home' && (
          ...
          >
            <div
              onClick={() => window.open(`${process.env.REACT_APP_API_URL || 'http://localhost:8080'}/sim/`, '_blank')}
              style={{
